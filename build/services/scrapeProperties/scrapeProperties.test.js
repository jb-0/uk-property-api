...
var scrapeProperties_1 = require("./scrapeProperties");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    pageLimit = 1000;
                    return [4 /*yield*/, scrapeProperties_1.getNumberOfPages(url, pageLimit)];
                case 1:
                    noOfPages = _a.sent();
    ...
    test('applying no explicit limit returns a page count of 3', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = baseURL + 'islington';
                    return [4 /*yield*/, scrapeProperties_1.getNumberOfPages(url)];
                case 1:
                    noOfPages = _a.sent();
    ...
    test('for a central london location 30 dwellings are returned', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = baseURL + 'islington';
                    return [4 /*yield*/, scrapeProperties_1.processSearch(url)];
                case 1:
                    dwellings = _a.sent();
    ...
    test('for a central london location ten dwellings are returned from the first page', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, scrapeProperties_1.scrapePropertiesFromPage(page)];
                case 4:
                    dwellings = _a.sent();
